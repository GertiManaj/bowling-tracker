...
foreach ($playerResults as $pid => $results) {
    // array_reverse: i risultati sono ordinati dal più recente al più vecchio
    // (query usa date DESC), li invertiamo per avere dal più vecchio al più recente
    // come nella dashboard
